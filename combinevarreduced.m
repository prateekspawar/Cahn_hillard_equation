...
J1_n=(2*chi*cn(1)*(1-cn(1))-1)*j1_1;
Jn_n=(2*chi*cn(N)*(1-cn(N))-1)*j1_n;  
J1_k=(2*chi*ck(1)*(1-ck(1))-1)*j1_1;
Jn_k=(2*chi*ck(N)*(1-ck(N))-1)*j1_n; 

cn_l=cn(2);
cn_r=cn(N-1)+(2*h)*Jn_n/(2*chi*cn(N)*(1-cn(N))-1);
ck_l=ck(2);
ck_r=ck(N-1)+(2*h)*Jn_k/(2*chi*ck(N)*(1-ck(N))-1);
